	...
	for {
		{
			...
			if enabled { // ask for more windows if we need them (non-blocking)
				sched.workerChange <- struct{}{} // worker�����������
			}
		}

		for { // ѭ���ȴ�woker�������񷵻ػ��е��ȴ��ڽ�����// wait for more windows to come in, or for tasks to get finished (blocking)
			if !sw.checkSession(ctx) { // ping the worker and check session ������Ӳ��ϣ����ú�һֱ��̽�������鷢��session id��һ��������
